    ...
    <div className="min-h-[100dvh] flex items-center justify-center bg-slate-950 overflow-y-auto relative px-4 py-8 sm:py-12">
      ...
      <div className="w-full max-w-md relative z-10 animate-in fade-in zoom-in-95 duration-700">
        <div className="text-center mb-8 sm:mb-10">
          <div className="mx-auto w-14 h-14 sm:w-16 sm:h-16 bg-[#8B1A1A] p-3 rounded-2xl shadow-xl shadow-red-950/50 mb-5 sm:mb-6 flex items-center justify-center">
          ...
          <form onSubmit={handleLogin} className="space-y-6">
            <div className="space-y-2">
              ...
              <input 
                ...
                className="w-full bg-slate-900/50 border border-slate-700 text-white rounded-xl sm:rounded-2xl px-4 sm:px-5 py-4 text-base sm:text-sm focus:border-[#8B1A1A] focus:bg-slate-900 transition-all font-bold placeholder:font-normal placeholder:text-slate-600 outline-none disabled:opacity-70"
            ...
            <div className="pt-4">
              <button 
                type="submit" 
                disabled={loading || !!successMsg}
                className="w-full bg-[#8B1A1A] hover:bg-[#681313] text-white py-4 sm:py-5 rounded-xl sm:rounded-2xl font-black uppercase tracking-[0.16em] sm:tracking-[0.2em] transition-all shadow-2xl shadow-red-950/40 border-b-4 border-red-950 flex items-center justify-center disabled:opacity-70"
              >
