      ...
      <div className="flex flex-col md:flex-row justify-between items-stretch md:items-end border-b border-slate-100 pb-6 md:pb-8 gap-4">
        <div className="min-w-0">
          <div className="flex items-center gap-2 mb-1">
            <span className="bg-[#8B1A1A] text-white text-[10px] font-black px-2 py-0.5 rounded tracking-wide md:tracking-widest uppercase italic">SESMT Digital • Cloud</span>
          </div>
        ...
        <div className="flex gap-2">
          <Link href="/delivery" className="w-full md:w-auto bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-xl font-bold text-sm shadow-lg shadow-blue-900/20 transition-all flex items-center justify-center">
