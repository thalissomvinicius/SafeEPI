    ...
    <>
      ...
      {isOpen && (
        <div className="fixed inset-0 z-[100] flex items-start justify-center pt-20 px-4">
          ...
          <div className="bg-white w-full max-w-2xl rounded-3xl shadow-2xl z-[110] overflow-hidden animate-in zoom-in-95 slide-in-from-top-10 duration-300 flex flex-col border border-slate-100">
            <div className="p-6 border-b border-slate-100 flex items-center gap-4">
              <Search className="w-6 h-6 text-[#8B1A1A]" />
              <input 
                ref={inputRef}
                type="text" 
                placeholder="Pesquise por Colaboradores, EPIs ou Canteiros..."
